...
class PiperTtsService {
  ...
  async ensureInitialized() {
    ...
    try {
      // Recharger les chemins depuis les settings au moment de l'initialisation
      const s = getSettings();
      this.piperPath = s.piper_tts_path || 'piper';
      this.modelPath = s.piper_model_path || './models/fr_FR-upmc-medium.onnx';
