import{i as e,n as t,o as n,t as r}from"./jsx-runtime-v183glR-.js";import{t as i}from"./CAlert-DVWND-vn.js";import{t as a}from"./CButton-BkTPU_2y.js";import{t as o}from"./CBadge-Byf3MxP6.js";import{n as s,t as c}from"./CCardBody-VW2P_cMC.js";import{t as l}from"./CCardHeader-D90gj24U.js";import{t as u}from"./CFormCheck-BdlolQDn.js";import{t as d}from"./CFormSelect-BtMGZk8z.js";import{n as f,t as p}from"./CRow-D2k1OpuZ.js";import{t as m}from"./cil-print-CpcdISMS.js";import{m as h,x as g}from"./index-mHOeP5Ec.js";import{c as _}from"./assetService-BgsdMgzx.js";import{t as v}from"./qrCodeService-l7dvP7Ax.js";var y=[`512 512`,`<path fill='var(--ci-primary-color, currentcolor)' d='M238.627 496H192V253.828l-168-200V16h456v37.612l-160 200v161.015ZM224 464h1.373L288 401.373V242.388L443.51 48H60.9L224 242.172Z' class='ci-primary'/>`],b=[`512 512`,`<path fill='var(--ci-primary-color, currentcolor)' d='M265.614 206.387H456V16h-32v133.887l-26.137-26.137c-79.539-79.539-208.96-79.54-288.5 0s-79.539 208.96 0 288.5a204.23 204.23 0 0 0 288.5 0l-22.627-22.627c-67.063 67.063-176.182 67.063-243.244 0s-67.063-176.183 0-243.246 176.182-67.063 243.245 0l28.01 28.01H265.614Z' class='ci-primary'/>`],x=n(e()),S=r(),C=()=>{let{t:e}=t(),[n,r]=(0,x.useState)([]),[C,w]=(0,x.useState)([]),[T,E]=(0,x.useState)(new Set),[D,O]=(0,x.useState)(!0),[k,A]=(0,x.useState)(!1),[j,M]=(0,x.useState)(``),[N,P]=(0,x.useState)(``),[F,I]=(0,x.useState)(``),[L,R]=(0,x.useState)(``);(0,x.useEffect)(()=>{z()},[]),(0,x.useEffect)(()=>{let e=[...n];N&&(e=e.filter(e=>e.location?.toLowerCase().includes(N.toLowerCase()))),F&&(e=e.filter(e=>e.department?.toLowerCase().includes(F.toLowerCase()))),L&&(e=e.filter(e=>e.type===L)),w(e),E(new Set)},[N,F,L,n]);let z=async()=>{O(!0),M(``);try{let e=await _();r(e),w(e),E(new Set)}catch{M(e(`print_qr.load_error`))}finally{O(!1)}},B=e=>[...new Set(n.map(t=>t[e]).filter(Boolean))].sort(),V=()=>{P(``),I(``),R(``)},H=C.length>0&&C.every(e=>T.has(e.id)),U=C.some(e=>T.has(e.id))&&!H,W=()=>{E(H?e=>{let t=new Set(e);return C.forEach(e=>t.delete(e.id)),t}:e=>{let t=new Set(e);return C.forEach(e=>t.add(e.id)),t})},G=e=>{E(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},K=C.filter(e=>T.has(e.id)),q=async()=>{let t=K.length>0?K:C;if(t.length!==0){A(!0),M(``);try{let n=(await Promise.all(t.map(async e=>{try{let t=await v(e.id);return{...e,qrSvg:t.qrSvg,qrUrl:t.url}}catch{return null}}))).filter(Boolean);if(n.length===0){M(e(`print_qr.no_qr_generated`));return}J(n)}catch{M(`Erreur lors de la génération des QR Codes.`)}finally{A(!1)}}},J=t=>{let n=window.open(``,`_blank`,`width=900,height=700`);if(!n){M(e(`print_qr.browser_blocked`));return}let r=t.map(e=>`
      <div class="label">
