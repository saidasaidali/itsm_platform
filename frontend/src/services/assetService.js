...
export const getAssetServices = async () => {
  const data = await api.get('/api/assets/services')
  return data.data
}

export const getAssetDepartments = async () => {
  const data = await api.get('/api/assets/departments')
  return data.data
}
